...
namespace ElectricSolution.Server.Migrations
{
    ...
    [Migration("20240405104339_20240404104621_DbModels-fix16")]
    partial class _20240404104621_DbModelsfix16
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ElectricSolution.Server.Api.Models.DbModels.TariffHours", b =>
                {
                    b.HasOne("ElectricSolution.Server.Api.Models.DbModels.TariffRate", "TariffRate")
                        .WithMany("TariffHours")
                        .HasForeignKey("TariffRateId");

                    b.Navigation("TariffRate");
                });
