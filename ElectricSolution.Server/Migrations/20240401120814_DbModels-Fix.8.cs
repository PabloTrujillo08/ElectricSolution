...
{
    /// <inheritdoc />
    public partial class DbModelsFix8 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContractFeatures_Features_FeatureId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContractFeatures_ContractId",
                table: "ContractFeatures",
                column: "ContractId");

            migrationBuilder.CreateIndex(
                name: "IX_ContractFeatures_FeatureId",
                table: "ContractFeatures",
                column: "FeatureId");
        }
