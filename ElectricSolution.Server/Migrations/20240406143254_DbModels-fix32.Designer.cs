...
namespace ElectricSolution.Server.Migrations
{
    ...
    [Migration("20240406143254_DbModels-fix32")]
    partial class DbModelsfix32
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ElectricSolution.Server.Api.Models.DbModels.Address", b =>
                {
                    ...
                    b.HasOne("ElectricSolution.Server.Api.Models.DbModels.Provinces", "ProvinceId")
                        .WithMany()
                        .HasForeignKey("ProvinceIdId");

                    b.Navigation("Client");

                    b.Navigation("ProvinceId");
                });
